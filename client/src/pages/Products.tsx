...
export default function Products() {
  ...
  const updateProductMutation = useMutation({
    mutationFn: async (data: ProductFormData) => {
      const response = await apiRequest("PUT", `/api/products/${editingProduct?.id}`, data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/products"] });
  ...
  return (
    <div className="p-4 pb-20">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-on-surface">Products & Services</h1>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        {product.stockQuantity <= product.minStockLevel && product.type === "product" && (
